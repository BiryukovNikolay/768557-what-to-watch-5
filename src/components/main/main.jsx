...
const Main = (props) => {
  const {films, activeGenre, changeFilter, getFilmsByFilter, filteredFilms} = props;
  const {
    title,
    poster,
    wallpaper,
    ...
    <div>
      ...
      <div className="page-content">
        <section className="catalog">
          ...
          />
          <MovieList movies={filteredFilms}/>
...
Main.propTypes = {
  ...
  filteredFilms: PropTypes.arrayOf(filmPropType).isRequired,
};
...
const mapDispatchToProps = (dispatch) => ({
  ...
  getFilmsByFilter(filterName) {
    dispatch(ActionCreator.getFilmsByFilter(filterName));
  },
});
