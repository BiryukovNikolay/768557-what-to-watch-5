...
const Main = (props) => {
  ...
  const dateRelize = film.dateRelize;

  return (
    <div>
      <div className="awesome" style={{border: `1px solid red`}}>
        <label htmlFor="name">Enter your name: </label><section className="movie-card">
          ...
          <div className="movie-card__wrap">
            <div className="movie-card__info">
              <div className="movie-card__poster">
                <img className="img/the-grand-budapest-hotel-poster.jpg" alt="The Grand Budapest Hotel poster" width={218} height={327} />
              </div>
              <div className="movie-card__desc">
                <h2 className="movie-card__title">{title}</h2>
                <p className="movie-card__meta">
                  <span className="movie-card__genre">{genre}</span>
                  <span className="movie-card__year">{dateRelize}</span>
                </p>
